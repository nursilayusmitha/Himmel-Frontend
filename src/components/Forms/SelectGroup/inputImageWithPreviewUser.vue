...
const imageSrc = ref<string | null>(props.modelValue instanceof File ? URL.createObjectURL(props.modelValue) : (typeof props.modelValue === 'string' ? API + '/images/user_internal/' + props.modelValue : null));
...
watch(() => props.modelValue, (newValue) => {
  if (newValue instanceof File) {
    ...
    imageSrc.value = API + '/images/user_internal/' + newValue;
