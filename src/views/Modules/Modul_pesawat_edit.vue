...
import { updateTransport, getTransportById } from "@/stores/functionAPI";
...
const pageTitle = ref("Modul - Edit Pesawat");
const pageList = ref(["Modul", "Pesawat", "Edit"]);
...
const submitData = async () => {
  ...
  if (result.isConfirmed) {
    try {
      ...
      await updateTransport(requestData, savedData.value._id);
      await successEdit();
