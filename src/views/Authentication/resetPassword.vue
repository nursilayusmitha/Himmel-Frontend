...
import { resetPasswordEksternal } from "@/stores/functionAPI"; // Sesuaikan nama API jika perlu
...
const submitData = async () => {
  ...
  const result = await Swal.fire({
    ...
    customClass: {
      ...
      htmlContainer: 'text-sm text-gray-600 dark:text-gray-300',
      confirmButton: 'text-white bg-[#009ee5] hover:bg-[#094fa4] rounded-lg text-sm px-4 py-2',
      cancelButton: 'text-[#009ee5] bg-white dark:bg-gray-700 border border-[#009ee5] hover:bg-[#f0faff] dark:hover:bg-gray-600 font-medium rounded-lg text-sm px-4 py-2 transition duration-150 ease-in-out',
  ...
  if (result.isConfirmed) {
    try {
      ...
      await resetPasswordEksternal(requestData);
    ...
    <div class="w-full max-w-lg mx-auto bg-white dark:bg-gray-800 px-8 py-10 rounded-xl shadow relative">
      ...
      <form id="reset-password-form">
        ...
        <div class="mb-6 relative">
          ...
          />
          <!-- Icon Mata -->
          <i class="absolute inset-y-0 right-4 flex items-center cursor-pointer justify-center mt-5 text-gray-500 dark:text-gray-300" @click="togglePasswordVisibility">
            <svg
              v-if="showPassword"
              :d="mdiEyeOffOutline"
              class="w-6 h-6"
        ...
        <div class="mb-6 relative">
          ...
          />
          <!-- Icon Mata -->
          <i class="absolute inset-y-0 right-4 flex items-center cursor-pointer justify-center mt-5 ml-2 text-gray-500 dark:text-gray-300" @click="toggleConfirmPasswordVisibility">
            <svg
