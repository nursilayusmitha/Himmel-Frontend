...
import { showLoading, successCreate, failedCreate, successData } from "@/stores/swal";
import { createUserEksternal } from "@/stores/functionAPI";
...
const savedData = ref({
  ...
  userPhone: "",
  userAddress: "",
  userAccess: [],  // Pre-set userAccess to the required values
  accessEdited: "N",
  userAccStatus: "enable",
  hierarchyCode: "3.1",  // Pre-set hierarchyCode
  userGender: "",
  userImage: null,
  imageName: null,
  userRole: "Pelanggan",  // Pre-set userRole
  isDeleted: "N",
  userProperties: [],
  user_created: "",
  user_updated: "",
    ...
    <form>
      ...
      <div class="mt-6 text-center">
        <p class="font-medium text-black dark:text-white mt-1">
            Sudah punya akun?
        <router-link to="/sign-in" class="text-[#009ee5] hover:underline">Yuk, Masuk ke akun kamu!</router-link>
        </p>
      </div>
    </form>
  </DefaultAuthCard>
